...
---@field public todo table Defines settings for todo list functionality.
local config = {
	-- A list of tables, where each table defines a wiki.
	-- If this is nil, the plugin will default to `~/wiki`.
	-- Example:
	-- wiki_dirs = {
	...
	-- Configuration for the todo functionality.
	todo = {
		...
		todo_progress_hl_group = "Comment",
	},
}
